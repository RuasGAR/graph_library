...
![Untitled](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled.png)
...
![*Estrutura hierárquica do projeto: menores componentes de modularização são as classes*](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled%201.png)
...
![Untitled](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled%202.png)
...
![Sem peso](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled%203.png)

Sem peso

![Com peso](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled%204.png)
...
![Untitled](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled%205.png)
...
![Untitled](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled%206.png)
...
![*Estruturas auxiliares para o algoritmo de Dijkstra com vetor*](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled%207.png)
...
- Dijkstra, implementado com fila de prioridade → instanciadas como heap, as filas de prioridade nos possibilita o acesso e extração de mínimos em tempo O(1) e O(log n), respectivamente. Ambas são bem menores do que a complexidade de acesso do vetor, que no pior caso exige uma passagem por todos os n vértices disponíveis. Dessa forma, a complexidade total de Dijkstra torna-se O((n+m) log n), o que é menor do que n² *em casos de grafos de baixa densidade*.
    ...
    Aqui são criados 10 itens na heap, cujas chaves são os identificadores de vértices e o valor, seu custo associado.](Documentação/Biblioteca%20de%20Grafos%20-%20(Python)%2033fd6a6d09e44a6ba3c2632aeb772b59/Untitled.jpeg)
